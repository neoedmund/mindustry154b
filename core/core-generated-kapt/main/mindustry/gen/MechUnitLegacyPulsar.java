...
public class MechUnitLegacyPulsar extends MechUnit implements Builderc, Drawc, ElevationMovec, Entityc, Healthc, Hitboxc, Itemsc, Mechc, Minerc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc {
  protected MechUnitLegacyPulsar() {
  }
  ...
  public void read(Reads read) {
    ...
    if(REV == 0) {
      ...
      throw new IllegalArgumentException("Unknown revision '" + REV + "' for entity type 'pulsar'");
    }
        afterRead();
  }
  ...
  public static MechUnitLegacyPulsar create() {
