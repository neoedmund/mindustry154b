...
public class LegsUnitLegacySpiroct extends LegsUnit implements Builderc, Drawc, Entityc, Healthc, Hitboxc, Itemsc, Legsc, Minerc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc {
  protected LegsUnitLegacySpiroct() {
  }
  ...
  public void read(Reads read) {
    ...
    if(REV == 0) {
      ...
      throw new IllegalArgumentException("Unknown revision '" + REV + "' for entity type 'spiroct'");
    }
        afterRead();
  }
  ...
  public static LegsUnitLegacySpiroct create() {
