...
public class CrawlUnit extends Unit implements Builderc, Crawlc, Drawc, Entityc, Healthc, Hitboxc, Itemsc, Minerc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc {
  ...
  @Override
  public void crawlTime(float crawlTime) {
    this.crawlTime = crawlTime;
  }

  @Override
  public void lastCrawlSlowdown(float lastCrawlSlowdown) {
    this.lastCrawlSlowdown = lastCrawlSlowdown;
  }
  ...
  @Override
  public void segmentRot(float segmentRot) {
  ...
  public void killed() {
    unit: {
        ...
        if (!type.flying || !type.createWreck) {
            ...
            type.wreckSound.at(this, 1.0F, type.wreckSoundVolume);
        }
    }
  }
  ...
  public void update() {
    ...
    crawl: {
        if (moving()) {
            ...
            int radius = (int)Math.max(0, hitSize / tilesize * 2.0F);
            int count = 0;
            int solids = 0;
            int deeps = 0;
            lastDeepFloor = null;
            ...
            lastCrawlSlowdown = Mathf.lerpDelta(1.0F, type.crawlSlowdown, Mathf.clamp((float)solids / count / type.crawlSlowdownFrac));
        }
  ...
  public void updateBuildLogic() {
        ...
        while ((buildCounter >= 1 || instant) && count++ < maxPerFrame && plans.size > 0) {
            ...
            if (!headless) {
                Vars.control.sound.loop(Sounds.loopBuild, tile, 1.0F);
            }
