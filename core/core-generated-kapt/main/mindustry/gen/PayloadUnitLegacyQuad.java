...
public class PayloadUnitLegacyQuad extends PayloadUnit implements Builderc, Drawc, Entityc, Healthc, Hitboxc, Itemsc, Minerc, Payloadc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc {
  protected PayloadUnitLegacyQuad() {
  }
  ...
  public void read(Reads read) {
    ...
    if(REV == 0) {
      ...
      throw new IllegalArgumentException("Unknown revision '" + REV + "' for entity type 'quad'");
    }
        afterRead();
  }
