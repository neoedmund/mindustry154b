...
public class BuildingTetherPayloadUnit extends Unit implements Builderc, BuildingTetherc, Drawc, Entityc, Healthc, Hitboxc, Itemsc, Minerc, Payloadc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc {
  ...
  protected BuildingTetherPayloadUnit() {
  }
  ...
  public void read(Reads read) {
    ...
    if(REV == 0) {
      ...
      throw new IllegalArgumentException("Unknown revision '" + REV + "' for entity type 'manifold'");
    }
        afterRead();
  }
  ...
  public static BuildingTetherPayloadUnit create() {
    return new BuildingTetherPayloadUnit();
  }
  ...
  public void destroy() {
    ...
    unit: {
        if (!isAdded() || !killable()) break unit;
