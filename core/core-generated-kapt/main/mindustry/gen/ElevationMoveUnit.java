...
public class ElevationMoveUnit extends Unit implements Builderc, Drawc, ElevationMovec, Entityc, Healthc, Hitboxc, Itemsc, Minerc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc {
  ...
  public static ElevationMoveUnit create() {
    return new ElevationMoveUnit();
  }
