...
public class BlockUnitUnit extends Unit implements BlockUnitc, Builderc, Drawc, Entityc, Healthc, Hitboxc, Itemsc, Minerc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc {
  ...
  @Annotations.ReadOnly
  protected transient Building tile;
  ...
  public void read(Reads read) {
    ...
    if(REV == 0) {
      ...
      throw new IllegalArgumentException("Unknown revision '" + REV + "' for entity type 'block'");
    }
        afterRead();
  }
  ...
  public static BlockUnitUnit create() {
