...
public class UnitEntityLegacyGamma extends UnitEntity implements Builderc, Drawc, Entityc, Healthc, Hitboxc, Itemsc, Minerc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc {
  protected UnitEntityLegacyGamma() {
  }
  ...
  public void read(Reads read) {
    ...
    if(REV == 0) {
      ...
      throw new IllegalArgumentException("Unknown revision '" + REV + "' for entity type 'gamma'");
    }
        afterRead();
  }
