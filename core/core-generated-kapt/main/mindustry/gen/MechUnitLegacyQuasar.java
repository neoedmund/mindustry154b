...
public class MechUnitLegacyQuasar extends MechUnit implements Builderc, Drawc, ElevationMovec, Entityc, Healthc, Hitboxc, Itemsc, Mechc, Minerc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc {
  protected MechUnitLegacyQuasar() {
  }
  ...
  public void read(Reads read) {
    ...
    if(REV == 0) {
      ...
      throw new IllegalArgumentException("Unknown revision '" + REV + "' for entity type 'quasar'");
    }
        afterRead();
  }
  ...
  public static MechUnitLegacyQuasar create() {
